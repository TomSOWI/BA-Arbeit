...
correlation2014P <- list()
correlation2014 <- list()

for (i in c("gruendl", "clara","claraK","kmeans","kmeansK")) {
    correlation <- cor.test(x = validation2014[[i]], y = validation2014$expert_rating, method = "pearson")
    correlation2014P[[i]] <- correlation$p.value
    correlation2014[[i]] <- correlation$estimate
}
