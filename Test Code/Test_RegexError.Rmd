...
df_kwic4 <- kwic(corp_compund_sentence3, pattern = terms_underscore  , valuetype = "regex", window = 1, case_insensitive = T)
#2033 #1988
df_kwic3 <- kwic(compund_sentence3, pattern = terms_underscore , valuetype = "regex", window = 1, case_insensitive = T)
