...
### Corpus cleaning
```{r}
corp_BT20 <- corpus(BT20, text_field = "speech_content")
token_BT20 <- tokens(corp_20,  remove_number =T)
class(token_BT20)
...
df_BT20 <- kwic(token_BT20, pattern = dict$populismus, valuetype = "regex", window = 7) #window 
