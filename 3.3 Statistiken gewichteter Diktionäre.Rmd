...
head(maxstats$original_pattern, 5) #höchste Gewichtung
tail(maxstats$original_pattern, 5) #niedrigste Gewichtung
...
dfClara10 <- dfClara[!(dfClara$pattern %in% minstats$original_pattern),]
